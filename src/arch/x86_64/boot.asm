...
enable_paging:
	...
	; enable PAE-flag in cr4 (Physical Addresss Extension)
	mov eax, cr4
	or eax, 1 << 5
	mov cr4, eax
...
check_cpuid:
	...
	; Compare EAX and ECX. If they are equal then that means the bit wan't
...
check_long_mode:
	...
	cpuid					; returns various feature bits in ecx
	test edx, 1 << 29
	jz .no_long_mode
	ret
.no_long_mode:
...
set_up_SSE:
	...
	; enable SSE
	mov eax, cr0
	and ax, 0xFFFB	; clear coproccessor emulation CR0.EM
