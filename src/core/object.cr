...
class Object
  ...
  # TODO: It must be implemented by Float32
  # abstract def hash
  ...
  # TODO: It must be implemented by Reference
  ...
  # TODO: It must be implemented by Int8
  # abstract def dup
  ...
  protected def self.set_crystal_type_id(ptr)
    ptr.as(LibCR::SizeT*).value = LibCR::SizeT.new(crystal_instance_type_id)
