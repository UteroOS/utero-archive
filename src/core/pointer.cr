...
# require "c/string"
require "./lib_cr/x86_64-linux-musl/c/string"
require "./lib_cr/x86_64-linux-musl/c/stdlib"
...
struct Pointer(T)
  ...
  #
  # See also: `Object#<=>`.
  # NOTE: Is `#<=>` in Comparable, not in Object?
  # def <=>(other : self)
  ...
  # def memcmp(other : Pointer(T), count : Int)
    ...
    # LibCR.memcmp(self.as(Void*), (other.as(Void*)), (count * sizeof(T)))
  # end
